...
class LearningPath {
  constructor({ name }) {
    this.name = name;
    this.courses = new Map(); // Use a Map to store courses
  }
  } 
...
const escuelaData=new 
LearningPath({name:"Escuela de Data Science",
  courses:[cursoProgBasica,"Curso DataBusiness","Curso Dataviz",],
});
  const escuelaVgs=new 
  LearningPath({name:"Escuela de Vidweojuegos",
 ...
 // learningPaths:[escuelaWeb,escuelaVgs,]
  const miguelito2=new Student({name:"Miguelito",username:"migelitofeliz",
